(ns quil-site.views.artblocks-juxt
  (:require [quil-site.views.page :refer [page]]))

(defn artblocks-juxt-page []
  (page {:tab :artblocks-juxt
         :type :artblocks-juxt-page
         :js-files ["https://cdn.jsdelivr.net/npm/p5@1.0.0/lib/p5.js" "js/ab_hash.js" "js/moc-ab-script-compiled-oct-tagged.js"]
