...
features an accurate copy of O’Hampsey’s" [:em " Downhill"] " harp, and shares the fruits of " [:a {:href "#projects"} "Mícheál’s 2017/18 Arts Council Traditional Arts Bursary"] "."]
            ...
            [:p "Mícheál’s profile is steadily increasing, as evidenced by his solo harp/vocal performance in June 2017 at Áras an Uachtarán for President Michael D Higgins and guests, appearance on Irish language channel TG4 in November 2017 as part of the inaugural National Harp Day, as well as solo performances in 2018 sharing the stage with luminaries of the early Irish harp Siobhán Armstrong, Ann Heymann, and Javier Sáinz. A valued member of the wider traditional music community, Mícheál performed at the Achill International Harp Festival in 2019."]
