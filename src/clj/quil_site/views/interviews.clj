...
[:section {:class "section"}
      ...
      [:div {:class "columns"}
       [:div {:class "column"}
        ...
        [:blockquote
         ...
         [:p "- Paul Dooley"]]
        (comment
          [:h2 [:strong [:a {:href="https://michealocathain.com/interviews/paul-dooley"} [:em "Early Irish Harp: the State of the Art"] " interview with Paul Dooley here"]]])
        [:hr]
        ...
        [:blockquote
         ...
         [:p "- Javier Sáinz"]]
        (comment
          [:h2 [:strong [:a {:href "https://michealocathain.com/interviews/javier-sainz"} [:em "Early Irish Harp: the State of the Art"] " interview with Jaiver Sáinz here"]]])
        [:hr]
        ...
        [:blockquote
         ...
         [:p "- Simon Chadwick"]]
        (comment
          [:h2 [:strong [:a {:href "https://michealocathain.com/interviews/simon-chadwick"} [:em "Early Irish Harp: the State of the Art"] " interview with Simon Chadwick here"]]])
        [:hr]
 ...
 got our own early harp in Ireland’! I’m quite a slow person, you know –
 it takes quite a while for the the penny to drop with me! I thought 
‘I’m playing the Spanish early harp and the Italian one and the European
 medieval one, but what about my own early harp?’ And once that penny 
dropped my whole life changed. That was it – I basically haven’t stopped
 running since."]
         [:p "- Siobhán Armstrong"]]
        (comment
          [:h2 [:strong [:a {:href "https://michealocathain.com/interviews/siobhan-armstrong"} [:em "Early Irish Harp: the State of the Art"] " interview with Siobhán Armstrong here"]]])
        [:hr]
        [:p [:em "Early Irish Harp: the State of the Art"] " interview series was funded through the Arts Council Deis Recording and Publication Award 2017"]
